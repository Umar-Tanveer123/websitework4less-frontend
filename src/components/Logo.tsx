  ...
  return (
    ...
    >
      ...
      >
        ...
        <g transform="translate(10, 65)" filter="url(#premium-3d)">
          <text
        ...
        <g transform="translate(330, 45)" stroke="url(#accent-grad)" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" filter="url(#premium-3d)">
